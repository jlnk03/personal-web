    ...
    <>
      ...
      <div className='grid sm:grid-cols-2 grid-cols-1 gap-5 pb-12 sm:pb-0'>
        <Link
          ...
          className='w-96 h-56 bg-blue-950 text-blue-100 rounded-xl overflow-hidden text-4xl font-bold items-center flex flex-col justify-center transition-shadow duration-300 ease-in-out hover:shadow-[0_0_10px_2px] hover:shadow-blue-400'
        >
        ...
        <Link
          ...
          id='points-cont'
          className='group relative w-96 h-56 bg-white rounded-xl overflow-hidden text-4xl font-bold items-center flex flex-col justify-center transition-shadow duration-300 ease-in-out hover:shadow-[0_0_10px_2px] hover:shadow-orange-200'
        >
        ...
        <Link
          href='/projects/lsg'
          id='points-cont'
          className='group parent relative w-96 h-56 bg-yellow-50 rounded-xl overflow-hidden text-4xl font-bold items-center flex flex-col justify-center transition-shadow duration-300 ease-in-out hover:shadow-[0_0_10px_2px] hover:shadow-yellow-200'
        >
          <span className='z-10'>LSG</span>
          <span className='text-sm font-normal mt-2 z-10'>LLM + Patents</span>

          <div className='w-full h-full absolute lightbulb '></div>
        </Link>
      </div>
    </>
  );
